...
<blockquote>ඔබගේ <b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss</b> ඉවත් කර ඇත.  
අපගේ සේවාව භාවිතා කළාට ස්තුතියි 🥳  
අපගේ වෙනත් plans පරීක්ෂා කිරීමට <b>/plan</b> click කරන්න.</blockquote>
"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/UltraX_Bots'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://github.com>UltraX Bots</a>\n """
...
• /sub - ꜱᴇᴀʀᴄʜ ꜱᴜʙᴛɪᴛʟᴇ ꜰɪʟᴇꜱ ɪɴ ᴛʜɪꜱ ɢʀᴏᴜᴘ."""
...
• /limitations - <code>ᴠɪᴇᴡ ᴅᴀɪʟʏ ʟɪᴍɪᴛꜱ.</code>
• /request - <code>ʀᴇǫᴜᴇꜱᴛ ᴀ ᴍᴏᴠɪᴇ.</code>
• /sub - <code>ꜱᴇᴀʀᴄʜ ꜱᴜʙᴛɪᴛʟᴇ ꜰɪʟᴇꜱ.</code>"""
