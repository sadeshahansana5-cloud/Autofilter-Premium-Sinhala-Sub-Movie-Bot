    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            try:
                ...
                logging.debug("Keep-alive ping failed; suppressed from normal logs")
