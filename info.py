...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003064465099')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003819851778')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/cinesubz_movie_support')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003661202269")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1004357221240")# Channels for force sub (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinesubz_movie_chat') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/UltraX_Bots') # Owner link for the bot
...
BAD_WORDS = {
    ...
    "tg",
    "original",
    "@sinhalasubtitles_rezoth",
    "(@sinhalasubtitles",
    "sinhalasubtitles_rezoth",
    "sinhalasubtitles",
    "rezoth",
    "@irupc.net_www_tamilrockers_",
    "@irupc.net",
    "www_tamilrockers_",
    "[irupc.net_]",
    ".net",
...
Bot_cmds = {
    ...
    "sub": "Search subtitle files",
    "limitations": "View daily limits"
}
